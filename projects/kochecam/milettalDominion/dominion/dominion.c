...
int adventurer_effect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus, int index, int currentPlayer, int nextPlayer, int tributeRevealedCards[2], int * temphand, int cardDrawn, int z){
  int drawntreasure = 0;
...
int minion_effect(int handPos, int currentPlayer, struct gameState *state, int i, int j, int choice1, int choice2){
  //+1 action
    state->numActions++;
...
int steward_effect(int handPos, int currentPlayer, struct gameState *state, int choice1, int choice2, int choice3){
  if (choice1 == 1){
    //+2 cards
    drawCard(currentPlayer, state);
    drawCard(currentPlayer, state);
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    {
    case adventurer:
    return adventurer_effect(card, choice1, choice2, choice3, state, handPos, bonus, index, currentPlayer, nextPlayer, tributeRevealedCards, temphand, cardDrawn, z);
  ...
  if (supplyCount(estate, state) > 0){
    ...
    case minion:
    return minion_effect(handPos, currentPlayer, state, i, j, choice1, choice2);
    
    case steward:
    return steward_effect(handPos, currentPlayer, state, choice1, choice2, choice3);
